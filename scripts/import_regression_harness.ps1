...
$hasNonMutatingImport = ($application -match 'queueAssetImportNonMutating' -or $application -match 'importAssetNonMutating') -and $application -match 'stagePlaceholderAssetImport'
