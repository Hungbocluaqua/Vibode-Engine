...
SceneGpuBuildResult SceneToGpuSceneBuilder::build(
    ...
    result.rendererSettings.lightingReuseMode = render.lightingReuseMode;
    result.rendererSettings.regirGridDimensions = render.regirGridDimensions;
    result.rendererSettings.regirReservoirsPerCell = render.regirReservoirsPerCell;
    result.rendererSettings.regirCandidatesPerReservoir = render.regirCandidatesPerReservoir;
    result.rendererSettings.regirGridPadding = render.regirGridPadding;
    result.rendererSettings.regirCanonicalMix = render.regirCanonicalMix;
    result.rendererSettings.regirQueryMode = render.regirQueryMode;
    result.rendererSettings.regirGridMode = render.regirGridMode;
    result.rendererSettings.regirFiniteQueryFramePeriod = render.regirFiniteQueryFramePeriod;
    result.rendererSettings.regirSpatialReuse = render.regirSpatialReuse;
    result.rendererSettings.regirSpatialRounds = render.regirSpatialRounds;
    result.rendererSettings.regirTemporalReuse = render.regirTemporalReuse;
    result.rendererSettings.regirTemporalHistory = render.regirTemporalHistory;
    result.rendererSettings.regirTemporalMaxM = render.regirTemporalMaxM;
    result.rendererSettings.regirVisibilityReuse = render.regirVisibilityReuse;
    result.rendererSettings.regirEnvironment = render.regirEnvironment;
    result.rendererSettings.pathReservoirLayout = render.pathReservoirLayout;
    result.rendererSettings.adaptiveSamplingMode = render.adaptiveSamplingMode;
    result.rendererSettings.adaptiveSamplingBudget = render.adaptiveSamplingBudget;
    result.rendererSettings.adaptiveWeightVariance = render.adaptiveWeightVariance;
    result.rendererSettings.adaptiveWeightHistory = render.adaptiveWeightHistory;
    result.rendererSettings.adaptiveWeightMotion = render.adaptiveWeightMotion;
    result.rendererSettings.adaptiveWeightDisocclusion = render.adaptiveWeightDisocclusion;
    result.rendererSettings.adaptiveWeightReactive = render.adaptiveWeightReactive;
    result.rendererSettings.adaptiveWeightEdge = render.adaptiveWeightEdge;
    result.rendererSettings.adaptiveWeightSpecular = render.adaptiveWeightSpecular;
    result.rendererSettings.adaptiveWeightDI = render.adaptiveWeightDI;
    result.rendererSettings.adaptiveWeightGI = render.adaptiveWeightGI;
    result.rendererSettings.adaptiveWeightVolumetric = render.adaptiveWeightVolumetric;
