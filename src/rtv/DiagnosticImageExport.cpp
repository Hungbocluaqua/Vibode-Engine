...
std::vector<RendererDebugView> DiagnosticImageExport::allExportViews() {
    return {
        ...
        RendererDebugView::RestirDiTemporalAcceptance,
        RendererDebugView::RestirDiSpatialAcceptance,
