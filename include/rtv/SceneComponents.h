...
struct RenderSettings {
    ...
    LightingReuseMode lightingReuseMode = LightingReuseMode::LegacyRestirDiGi;
    ReservoirLayout pathReservoirLayout = ReservoirLayout::LegacyDI;
    glm::uvec3 regirGridDimensions{64u, 64u, 64u};
    uint32_t regirReservoirsPerCell = 16;
    uint32_t regirCandidatesPerReservoir = 32;
    float regirGridPadding = 0.10f;
    float regirCanonicalMix = 0.25f;
    ...
    bool regirSpatialReuse = false;
    uint32_t regirSpatialRounds = 1;
    bool regirTemporalReuse = false;
    uint32_t regirTemporalHistory = 0;
    uint32_t regirTemporalMaxM = 32;
    bool regirVisibilityReuse = false;
    bool regirEnvironment = false;
