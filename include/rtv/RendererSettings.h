...
inline void applyRenderPreset(RendererSettings& settings, RenderPreset preset) {
    ...
    settings.regirGridDimensions = glm::uvec3{64u, 64u, 64u};
    settings.regirReservoirsPerCell = 16;
    settings.regirCandidatesPerReservoir = 32;
    settings.regirGridPadding = 0.10f;
    settings.regirCanonicalMix = 0.25f;
    ...
    settings.regirVisibilityReuse = false;
